...
function DsApp()
{
    ...
    /*#app*/ this.Func = function( name, args ) {
        ...
        app.Execute( "_OnFunc('"+btoa(JSON.stringify(Array.from(arguments)))+"')", function(){} )
    }
...
function Web( id )
{
    ...
    /*#web*/ obj.Func = function( name, args ) {
        for( var a in arguments )
            if( typeof arguments[a]=='function' ) arguments[a] = _Cbm(arguments[a])
        obj.Execute( "_OnFunc('"+btoa(JSON.stringify(Array.from(arguments)))+"')", function(){} )
    }
    return obj;
}
...
_OnFunc = function( json ) { var args=JSON.parse(atob(json)); return eval(args[0]).apply(window,args.splice(1)) }
...
cfg = { Game:0, Landscape:0, Portrait:0, Transparent:0, Share:0, USB:0, Light:0, Dark:0,
        Holo:0, MUI:0, Node:0, NodeESM:0, Fast:0 }
